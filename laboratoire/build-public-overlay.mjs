...
const manifest={bundle:'antmux-laboratoire-public',lab:'LAB-004',release_kind:'OVERLAY',deploy_target_hint:'/',home_button:'/laboratoire/',lab_entry:'/laboratoire/',genesis_entry:'/laboratoire/genesis/',genesis_contract_version:'2.0.0-draft',genesis_mode:'DEMO',source_status:'SYNTHETIC',private_genesis_connected:false,generator_modified:false,destructive_deploy_required:false,files:manifestFiles};
